...
<body>
	<div id="body_div">
		<header>
			...
			<div id="header_div">
				<a href="index.bizpoll">
					<img alt="may"src="img/logo_002.png">
				</a>
			</div>
		...
		<form action="MemberplayUpdate.bizpoll" method="POST" name="frm_mem" id="frm_mem">
		...
		<div id="insert_id" class="insert_div">
			...
			<input type="text" id="input_id" name="input_id" class="input_class" value="${sessionScope.loginUser.id}" readonly="readonly" >
		...
		<div id="insert_name" class="insert_div">
			...
			<input type="text" id="input_name" name="input_name" class="input_class" value="${sessionScope.loginUser.name}">
		...
		<div id="insert_ph" class="insert_div">
			...
			<input type="text" id="input_ph" name="input_ph" class="input_class" maxlength=11 value="${sessionScope.loginUser.phone}">
			<span class="error">필수 정보입니다 </span>
		</div>
